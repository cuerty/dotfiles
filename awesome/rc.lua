...
beautiful.init("/home/qwerty/.config/awesome/themes/cuerty/theme.lua")
...
tag_names = {'web','im','code1','code2','code3','code4','code5','management','email'}
for s = 1, screen.count() do
    ...
    for tagnumber = 1, 9 do
        tags[s][tagnumber] = tag(tag_names[tagnumber])
